...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Aman5624/WorkForce-Management-System.git
...
- `Frontend/environment.ts` - Angular development configuration
- `Frontend/environment.prod.ts` - Angular production configuration
